...
\lean{Generated/BlueprintSkeleton.lean}, declares five vacuous \lean{axiom ... : True} postulates
from an early scaffold; they are imported nowhere, and the enforced footprints below prove that no
guarded theorem depends on them.) Following~\cite{FLT2026}, the axiom footprint is enforced rather than
