...
\date{\today\\[0.6em]
  \small Archivé sur Zenodo : \href{https://doi.org/10.5281/zenodo.22541930}{\texttt{10.5281/zenodo.22541930}}}
...
\paragraph{Artefact.}
Archivé sur Zenodo, \href{https://doi.org/10.5281/zenodo.22541930}{\texttt{doi:10.5281/zenodo.22541930}},
...
La configuration de compilation n'est \emph{pas} distribuée : notre \texttt{lakefile.lean} code en
dur des chemins absolus vers un dépôt local de paquets Mathlib, de sorte que l'artefact n'est pas
encore compilable par un tiers sans qu'il fournisse sa propre copie de Mathlib au commit indiqué.
Un \texttt{lakefile} portable reste à écrire, et nous le signalons comme l'obstacle principal à une
...
Zenodo sous le DOI \texttt{10.5281/zenodo.22541930}. Les deux versions ont le même contenu
