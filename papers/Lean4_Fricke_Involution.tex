...
\title{\textbf{A Mathlib-Idiomatic Formalization of the Fricke \\ Involution and its Operator on Modular Forms}}
\author{
  Xavier Callens\thanks{Corresponding author: \texttt{callensxavier@gmail.com}} \\
  \small SocrateAI Research Initiative
}
\date{\today\\[0.6em]
  \small Archived at Zenodo: \href{https://doi.org/10.5281/zenodo.22541930}{\texttt{10.5281/zenodo.22541930}}}
...
\paragraph{Artifact.}
Archived at Zenodo, \href{https://doi.org/10.5281/zenodo.22541930}{\texttt{doi:10.5281/zenodo.22541930}},
...
with the axiom guards in \texttt{Lean/SocrateAI/FinalCheck.lean};
...
The build configuration is \emph{not} distributed: our \texttt{lakefile.lean} hard-codes absolute
paths into a local Mathlib package pool, so the artifact is not yet buildable by a third party
without supplying their own Mathlib at the pinned commit. A portable lakefile is outstanding work,
and we flag it as the main obstacle to independent replication.
...
\lean{Mathlib.NumberTheory.ModularForms.SlashInvariantForms} and
...
\texttt{Thm\_CuspForm\_hasNebentypus\_inv\_and\_qCoeff\_hecke\_eigen\_of\_fricke} and
...
The same operator is the modular-side input to the moonshine correspondences studied
elsewhere in this programme. With the operator now defined on \lean{ModularForm}, the immediate next steps are the
...
\bibitem{Tao2026AI} T.~Tao, \textit{Mathematics in the age of AI}, lecture at the International Congress of Mathematicians 2026; arXiv:2608.16753.
