...
eight headline theorems inside the default build target, so any widening of the axiom set is
...
\texttt{lake build SocrateAI} completes in 2346 jobs (including the axiom-guard module).
